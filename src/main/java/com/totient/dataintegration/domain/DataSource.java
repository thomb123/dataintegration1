...
public class DataSource implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "dataSources", allowSetters = true)
    ...
    public ProcessGroupTemplate getProcessGroupTemplate() {
        return processGroupTemplate;
    }

    public DataSource processGroupTemplate(ProcessGroupTemplate processGroupTemplate) {
        this.processGroupTemplate = processGroupTemplate;
        return this;
    }

    public void setProcessGroupTemplate(ProcessGroupTemplate processGroupTemplate) {
        this.processGroupTemplate = processGroupTemplate;
    }
